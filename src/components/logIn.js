...
const LogIn = () => {
    ...
    const handleSubmit = (e) => {
        ...
        return new Promise((resolve, reject) => {
            const resLogIn = axios.post('http://localhost:5000/theme/log', {
                email,
                password
            }).then((data) => {
                ...
                if (Object.keys(data.data) != 0) {
                    ...
                    localStorage.setItem("details", data.data._id)
                        ...
                        <div className="col-12 d-flex align-items-center justify-content-center">
                            <div className="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                                ...
                                <form action="#" className="mt-4" onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-group mb-4">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="email" className="form-control" placeholder="example@company.com" id="email" autoFocus required value={email} onChange={(e) => handkeEmail(e)} />
                                        </div>
                                    </div>
                                    {/* <!-- End of Form --> */}
                                    <div className="form-group">
                                        ...
                                        <div className="form-group mb-4">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input type="password" placeholder="Password" className="form-control" id="password" required value={password} onChange={(e) => handlePassword(e)} />
                                            </div>
                                        </div>
                                        {/* <!-- End of Form --> */}
                                ...
                                <div className="d-grid">
                                    ...
                                    <button  className="btn btn-gray-800">SignUp</button>
                                    </Link>
                                    </div>
