...
import img from '../image/signin.svg'
...
// const logout =() => {
//    console.log(localStorage.setItem("user", out));
// }
...
const SignUp = () => {
    ...
    const submit = async(e) => {
        ...
        const resSignUp = await axios.post('http://localhost:5000/theme/', {
            name,
            email,
            password
        })
      ...
      if(resSignUp.data.statusCode == '200'){
                ...
                <div>
                    ...
                    <form onSubmit={submit}>
                        <div>
                            ...
                            <input id="name" type="text" value={name} onChange={(e) => { handleName(e) }}></input>
                        </div>
                        <div>
                            <label htmlFor="email">Email</label>
                            <input id="email" type="text" value={email} onChange={(e) => { handleEmail(e) }}></input>
                        </div>
                        <div>
                            <label htmlFor="password">password</label>
                            <input id="password" type="text" value={password} onChange={(e) => handlePassword(e)}></input>
                        </div>
                        <div>
                            ...
                            <form action="#" class="mt-4" onSubmit={submit}>
                                ...
                                <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Enter Name" class="form-control" id="confirm_password" required autoComplete="off" value={name} onChange={(e) => handleName(e)}/>
                                        </div>  
                                    </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="example@company.com" id="email" autofocus required  autocomplete="off" value={email} onChange={(e) => handleEmail(e)} />
                                    </div>  
                                </div>
                                {/* <!-- End of Form --> */}
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" placeholder="Password" class="form-control" id="password" required autocomplete="off" value={password} onChange={(e) => handlePassword(e)} />
                                        </div>  
                                    </div>
                                    {/* <!-- End of Form -->
                                    <!-- Form --> */}
